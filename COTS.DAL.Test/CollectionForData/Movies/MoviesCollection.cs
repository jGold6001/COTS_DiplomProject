        ...
        public static List<Movie> Get()
        {
            ...
            return new List<Movie>()
            {
                new Movie("Бегущий по лезвию 2049", "ТРИЛЛЕР, ФАНТАСТИКА",
                        ...
                        "https://youtu.be/dreF80r7F14","https://s3.amazonaws.com/cinema.tickets.ua/movie/poster/thumb/movie-1506527424.jpg?1506527519", dateIssue_1, 5),
                ...
                new Movie("My Little Pony в кино", "МУЛЬТФИЛЬМ, ПРИКЛЮЧЕНИЕ, КОМЕДИЯ, МУЗЫКАЛЬНЫЙ",
                        "Шестерка любимых героев — Эпплджек, Сумеречная Искорка, Флаттершай, Пинки Пай, Рарити и Радуга Дэш — теперь на большом экране! Король Шторм хочет лишить пони магии и захватывает Кантерлот. Под угрозой будущее всей Эквестрии! Чтобы остановить злодея, пони покидают родные края и отправляются в путешествие, полное чудес и опасностей. Им предстоит покорить волшебные горы, погрузиться в подводные миры и даже оказаться на летучем пиратском корабле!",
                         ...
                         "https://youtu.be/uVORfWM1_9E","https://s3.amazonaws.com/cinema.tickets.ua/movie/poster/thumb/movie-1506528035.jpg?1506528140", dateIssue_2, 0),
                ...
                new Movie("Салют-7", "ДРАМА",
                        ...
                        "https://youtu.be/XY8eYVXJO8g","https://s3.amazonaws.com/cinema.tickets.ua/movie/poster/thumb/movie-1497345894.jpg?1497345897", dateIssue_3, 1),

                new Movie("Коматозники", "ФАНТАСТИКА, УЖАСЫ, ДРАМА",
                        ...
                        "https://youtu.be/o-0NPBhy9vs", "https://s3.amazonaws.com/cinema.tickets.ua/movie/poster/thumb/movie-1506528195.jpg?1506528335", dateIssue_4, 2)
            };
        }
    }
}
